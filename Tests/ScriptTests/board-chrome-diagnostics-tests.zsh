...
cat > "$fixture_root/incomplete.ndjson" <<'EOF'
{"diagnosticKind":"interaction-frame","topMenu":{"x":16,"width":100},"topToolbar":{"x":20,"width":50},"bottomLeft":{"x":16,"y":80,"width":20},"viewport":{"width":100,"height":100}}
{"diagnosticKind":"interaction-frame","topMenu":{"x":16,"width":100},"topToolbar":{"x":20},"bottomLeft":{"x":16,"y":80,"width":20},"viewport":{"width":100,"height":100}}
EOF
...
if python3 -B "$reporter" "$fixture_root/incomplete.ndjson" >/dev/null; then
    echo "Expected incomplete Board chrome geometry to fail the diagnostic gate." >&2
    exit 1
fi
